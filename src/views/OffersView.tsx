...
export const OffersView: React.FC<OffersViewProps> = ({ setActivePage }) => {
  ...
  const { offers, initialLoading } = useHotelData();
  ...
  return (
    <div className="section">
      <div className="container">
        ...
        {initialLoading && offers.length === 0 ? (
          <div className="grid grid--3">
            {[1, 2, 3].map((n) => (
              <div key={n} className="info-card flex flex-col justify-between animate-pulse">
                <div className="space-y-4">
                  <div className="h-6 bg-[#E8DED0] rounded-full w-1/3" />
                  <div className="h-7 bg-[#E8DED0] rounded w-3/4" />
                  <div className="h-14 bg-[#E8DED0]/50 rounded w-full" />
                  <div className="h-20 bg-[#E8DED0]/30 rounded w-full" />
                </div>
                <div className="mt-8">
        ...
        <div className="dark-card mt-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button onClick={handleEventsClick} className="btn btn--primary whitespace-nowrap">
